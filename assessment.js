...
//note!: The repeat() method constructs and returns a new string which contains the specified number of copies of the string on which it was called, concatenated together.
...
function makeChatMessage(message, author) {
	var obj = {
		message: message,
		author: author,
		timestamp: new Date()//note: If no arguments are provided, the constructor creates a JavaScript Date object for the current date and time according to system settings. COOL!
		}
	return obj;
};
